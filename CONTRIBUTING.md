...
¡Gracias por tu interés en contribuir a **Sistema de Votación PostgreSQL**! Esta guía describe el flujo de trabajo, los estándares de código y el proceso de Pull Requests.
...
- Sigue las convenciones idiomáticas de PostgreSQL (p. ej. `camelCase`/`snake_case`/`PascalCase` según corresponda).
...
- Verifica una carga limpia del esquema y los seeds antes de abrir el PR (ver [`docs/conventions/testing.md`](docs/conventions/testing.md)).
