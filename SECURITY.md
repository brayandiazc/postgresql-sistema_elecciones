...
Este documento describe cómo reportar vulnerabilidades en **Sistema de Votación PostgreSQL** y qué prácticas de seguridad seguimos en el repositorio.
...
| Releases / tags         | Solo la última versión        |
...
El proyecto es SQL puro y **no tiene dependencias de paquetes** ni lockfile. La única
superficie externa es el motor PostgreSQL: mantenlo actualizado con los parches de
seguridad de tu distribución o proveedor.
...
> Versión: 1.0 — Última actualización: 2026-06-30
